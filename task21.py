"""Elements Common in Exactly 2 Sets
...
e=b
print((a|b)^b)"""
"""Write a Python program to check whether the intersection of two sets forms a sequence of consecutive numbers.
Input:
A = {2, 3, 4, 5, 8}
B = {1, 2, 3, 4, 5}
Output:
